...
/* Kefyros: kept at 256. UTF-8 Japanese paths under /kefyros/music are at most
   201 bytes, so 256 fits with margin. (Bumping to 512 overflowed the 4 KB core-0
   stack in fat.c's char fpath[PATH_MAX] locals during kfs_mount -> black screen.) */
#define PATH_MAX   256
