...
#define KF_BUS_HZ_MAX    45000000u   /* fastest divider we'll try (÷-rounded to achievable).
                                        At the 360 MHz UI clock: ÷4=45 passes calibration, the
                                        one-notch margin settles on ÷5=36 — this board's proven
                                        stable ceiling (÷3=60 fails). ÷6=30 is the slow fallback. */
